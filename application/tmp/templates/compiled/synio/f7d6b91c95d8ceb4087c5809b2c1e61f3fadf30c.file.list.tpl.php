<?php /* Smarty version Smarty-3.1.13, created on 2018-06-26 19:25:40
         compiled from "C:\xampp\htdocs\application\plugins\admin\frontend\skin\default\actions\ActionAdmin\category\list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13994401785b326904494823-17448114%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f7d6b91c95d8ceb4087c5809b2c1e61f3fadf30c' => 
    array (
      0 => 'C:\\xampp\\htdocs\\application\\plugins\\admin\\frontend\\skin\\default\\actions\\ActionAdmin\\category\\list.tpl',
      1 => 1493631928,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '13994401785b326904494823-17448114',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b32690451d3c1_30595835',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b32690451d3c1_30595835')) {function content_5b32690451d3c1_30595835($_smarty_tpl) {?><?php if (!is_callable('smarty_function_router')) include 'C:\\xampp\\htdocs\\framework/classes/modules/viewer/plugs\\function.router.php';
...
<div id="container" class=" <?php if ($_smarty_tpl->tpl_vars['bNoSidebar']->value){?>no-sidebar<?php }?>">
	...
	<?php ob_start();?><?php echo smarty_function_router(array('page'=>"admin/categories/".((string)$_smarty_tpl->tpl_vars['oCategoryType']->value->getTargetType())."/create"),$_smarty_tpl);?>
<?php $_tmp1=ob_get_clean();?><?php echo smarty_function_component(array('_default_short'=>'admin:button','text'=>$_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['add'],'url'=>$_tmp1,'mods'=>'primary'),$_smarty_tpl);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
	...
	Категории типа &laquo;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['oCategoryType']->value->getTitle(), ENT_QUOTES, 'UTF-8', true);?>
&raquo;
</h2>
	...
	<?php echo smarty_function_component(array('_default_short'=>'admin:p-category','template'=>'list','categories'=>$_smarty_tpl->tpl_vars['aCategoryItems']->value),$_smarty_tpl);?>
