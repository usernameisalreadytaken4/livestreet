<?php /* Smarty version Smarty-3.1.13, created on 2018-06-26 19:25:49
         compiled from "C:\xampp\htdocs\application\plugins\admin\frontend\skin\default\actions\ActionAdmin\category\create.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3954514605b32690d3a4528-04594625%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '40a1315d210f5be1e5bc30222d50fb1f41c8e754' => 
    array (
      0 => 'C:\\xampp\\htdocs\\application\\plugins\\admin\\frontend\\skin\\default\\actions\\ActionAdmin\\category\\create.tpl',
      1 => 1493631928,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3954514605b32690d3a4528-04594625',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b32690d42d0c6_10220975',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b32690d42d0c6_10220975')) {function content_5b32690d42d0c6_10220975($_smarty_tpl) {?><?php if (!is_callable('smarty_function_router')) include 'C:\\xampp\\htdocs\\framework/classes/modules/viewer/plugs\\function.router.php';
...
?><!doctype html>
	...
	<?php ob_start();?><?php echo smarty_function_router(array('page'=>"admin/categories/".((string)$_smarty_tpl->tpl_vars['oCategoryType']->value->getTargetType())),$_smarty_tpl);?>
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['layoutBackUrl'] = new Smarty_variable($_tmp1, null, 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
	...
	<?php if ($_smarty_tpl->tpl_vars['_aRequest']->value){?>
		Редактирование категории типа &laquo;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['oCategoryType']->value->getTitle(), ENT_QUOTES, 'UTF-8', true);?>
&raquo;
	<?php }else{ ?>
		Добавление категории для типа &laquo;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['oCategoryType']->value->getTitle(), ENT_QUOTES, 'UTF-8', true);?>
&raquo;
	<?php }?>
</h2>
	...
	<?php echo smarty_function_component(array('_default_short'=>'admin:p-category','template'=>'form','categories'=>$_smarty_tpl->tpl_vars['aCategoryItems']->value),$_smarty_tpl);?>
