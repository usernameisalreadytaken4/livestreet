<?php /* Smarty version Smarty-3.1.13, created on 2018-06-28 18:45:48
         compiled from "C:\xampp\htdocs\application\frontend\skin\developer\actions\ActionBlog\blog.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11823115895b3502aca63021-06010534%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5efb78ad30622d8a18c800238a8c362a82d1d9a1' => 
    array (
      0 => 'C:\\xampp\\htdocs\\application\\frontend\\skin\\developer\\actions\\ActionBlog\\blog.tpl',
      1 => 1530188511,
      2 => 'file',
    ),
    'b5a3f69bda9a969b43b3151d7c926c6a97441b2f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\application\\frontend\\skin\\developer\\layouts\\layout.topics.tpl',
      1 => 1530188513,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '11823115895b3502aca63021-06010534',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b3502acb785e0_50451315',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b3502acb785e0_50451315')) {function content_5b3502acb785e0_50451315($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include 'C:\\xampp\\htdocs\\framework/classes/modules/viewer/plugs\\function.component_define_params.php';
...
<?php $_tmp2=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_lang(array('name'=>'blog.menu.all_discussed'),$_smarty_tpl);?>
<?php $_tmp3=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_lang(array('name'=>'blog.menu.all_top'),$_smarty_tpl);?>
<?php $_tmp4=ob_get_clean();?><?php $_smarty_tpl->createLocalArrayVariable('layoutNav', null, 0);
$_smarty_tpl->tpl_vars['layoutNav']->value[] = array('hook'=>'topics_sub','activeItem'=>$_smarty_tpl->tpl_vars['sMenuSubItemSelect']->value,'items'=>array(array('name'=>'good','url'=>$_smarty_tpl->tpl_vars['sNavTopicsSubUrl']->value,'text'=>$_tmp1),array('name'=>'new','url'=>((string)$_smarty_tpl->tpl_vars['sNavTopicsSubUrl']->value)."newall/",'text'=>$_tmp2),array('name'=>'discussed','url'=>((string)$_smarty_tpl->tpl_vars['sNavTopicsSubUrl']->value)."discussed/",'text'=>$_tmp3),array('name'=>'top','url'=>((string)$_smarty_tpl->tpl_vars['sNavTopicsSubUrl']->value)."top/",'text'=>$_tmp4)));?>
...
<?php $_tmp5=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_lang(array('_default_short'=>'blog.menu.top_period_7'),$_smarty_tpl);?>
<?php $_tmp6=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_lang(array('_default_short'=>'blog.menu.top_period_30'),$_smarty_tpl);?>
<?php $_tmp7=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_lang(array('_default_short'=>'blog.menu.top_period_all'),$_smarty_tpl);?>
<?php $_tmp8=ob_get_clean();?><?php $_smarty_tpl->createLocalArrayVariable('layoutNav', null, 0);
$_smarty_tpl->tpl_vars['layoutNav']->value[] = array('hook'=>'topics_sub_timespan','activeItem'=>$_smarty_tpl->tpl_vars['periodSelectCurrent']->value,'items'=>array(array('text'=>htmlspecialchars($_smarty_tpl->tpl_vars['periodSelectCurrentTitle']->value, ENT_QUOTES, 'UTF-8', true),'menu'=>array('activeItem'=>$_smarty_tpl->tpl_vars['periodSelectCurrent']->value,'items'=>array(array('name'=>'1','url'=>((string)$_smarty_tpl->tpl_vars['periodSelectRoot']->value)."?period=1",'text'=>$_tmp5),array('name'=>'7','url'=>((string)$_smarty_tpl->tpl_vars['periodSelectRoot']->value)."?period=7",'text'=>$_tmp6),array('name'=>'30','url'=>((string)$_smarty_tpl->tpl_vars['periodSelectRoot']->value)."?period=30",'text'=>$_tmp7),array('name'=>'all','url'=>((string)$_smarty_tpl->tpl_vars['periodSelectRoot']->value)."?period=all",'text'=>$_tmp8))))));?>
        <?php }?>
    <?php }?>
...
">
    ...
    <?php echo smarty_function_component(array('_default_short'=>'blog','blog'=>$_smarty_tpl->tpl_vars['blog']->value,'blogs'=>$_smarty_tpl->tpl_vars['blogs']->value),$_smarty_tpl);?>
...
?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['blogUserCurrent']->value&&$_smarty_tpl->tpl_vars['blogUserCurrent']->value->getIsBanned()){?>
        <?php echo smarty_function_component(array('_default_short'=>'alert','text'=>$_smarty_tpl->tpl_vars['aLang']->value['blog']['alerts']['banned'],'mods'=>'error'),$_smarty_tpl);?>

    <?php }?>

    
    <?php if ($_smarty_tpl->tpl_vars['isPrivateBlog']->value){?>
        <?php echo smarty_function_component(array('_default_short'=>'alert','text'=>$_smarty_tpl->tpl_vars['aLang']->value['blog']['alerts']['private'],'mods'=>'error'),$_smarty_tpl);?>
