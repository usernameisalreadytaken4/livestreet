<?php /* Smarty version Smarty-3.1.13, created on 2018-06-28 14:52:56
         compiled from "/home/mmotalks/web/mmotalks.ru/public_html/cms/application/plugins/admin/frontend/components/p-settings/fields/field.enum.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9554715335b34cc186066c7-12776363%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e2c747955710ddec752daaa94fa1e60cd26cb2d0' => 
    array (
      0 => '/home/mmotalks/web/mmotalks.ru/public_html/cms/application/plugins/admin/frontend/components/p-settings/fields/field.enum.tpl',
      1 => 1529954541,
      2 => 'file',
    ),
    'aacea05205d492a9b5c3d677bbdef4ff5c3f0e0e' => 
    array (
      0 => '/home/mmotalks/web/mmotalks.ru/public_html/cms/framework/frontend/components/field/field.select.tpl',
      1 => 1529954577,
      2 => 'file',
    ),
    '738daa384ab41636c06adbab7f882932b6f8159f' => 
    array (
      0 => '/home/mmotalks/web/mmotalks.ru/public_html/cms/framework/frontend/components/field/field.tpl',
      1 => 1529954577,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9554715335b34cc186066c7-12776363',
  'function' => 
  array (
  ...
  'unifunc' => 'content_5b34cc188b69d3_02251453',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b34cc188b69d3_02251453')) {function content_5b34cc188b69d3_02251453($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/home/mmotalks/web/mmotalks.ru/public_html/cms/framework/classes/modules/viewer/plugs/function.component_define_params.php';
if (!is_callable('smarty_function_field_make_rule')) include '/home/mmotalks/web/mmotalks.ru/public_html/cms/framework/classes/modules/viewer/plugs/function.field_make_rule.php';
if (!is_callable('smarty_function_field_get_value')) include '/home/mmotalks/web/mmotalks.ru/public_html/cms/framework/classes/modules/viewer/plugs/function.field_get_value.php';
...
if (!is_callable('smarty_function_cdata')) include '/home/mmotalks/web/mmotalks.ru/public_html/cms/framework/classes/modules/viewer/plugs/function.cdata.php';
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['value'] = new Smarty_variable((($tmp = @$_tmp1)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['value']->value : $tmp), null, 0);?>
    ...
    <?php echo smarty_function_component_define_params(array('params'=>array('parameter','key','formid')),$_smarty_tpl);?>


    <?php $_smarty_tpl->tpl_vars['label'] = new Smarty_variable($_smarty_tpl->tpl_vars['parameter']->value->getName(), null, 0);?>
    <?php $_smarty_tpl->tpl_vars['note'] = new Smarty_variable($_smarty_tpl->tpl_vars['parameter']->value->getDescription(), null, 0);?>
    <?php $_smarty_tpl->tpl_vars['selectedValue'] = new Smarty_variable(htmlspecialchars($_smarty_tpl->tpl_vars['parameter']->value->getValue(), ENT_QUOTES, 'UTF-8', true), null, 0);?>

    
    <?php $_smarty_tpl->tpl_vars['validatorData'] = new Smarty_variable($_smarty_tpl->tpl_vars['parameter']->value->getValidator(), null, 0);?>
    <?php $_smarty_tpl->tpl_vars['validatorParams'] = new Smarty_variable($_smarty_tpl->tpl_vars['validatorData']->value['params'], null, 0);?>

    
    <?php $_smarty_tpl->tpl_vars['enum'] = new Smarty_variable($_smarty_tpl->tpl_vars['validatorParams']->value['enum'], null, 0);?>
    <?php $_smarty_tpl->tpl_vars['items'] = new Smarty_variable(array(), null, 0);?>

    
    <?php if ($_smarty_tpl->tpl_vars['validatorParams']->value['allowEmpty']){?>
        <?php $_smarty_tpl->createLocalArrayVariable('items', null, 0);
$_smarty_tpl->tpl_vars['items']->value[] = array('text'=>'---','value'=>'');?>
    <?php }?>

    <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['enum']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
        <?php $_smarty_tpl->createLocalArrayVariable('items', null, 0);
$_smarty_tpl->tpl_vars['items']->value[] = array('text'=>htmlspecialchars($_smarty_tpl->tpl_vars['item']->value, ENT_QUOTES, 'UTF-8', true),'value'=>htmlspecialchars($_smarty_tpl->tpl_vars['item']->value, ENT_QUOTES, 'UTF-8', true));?>
    <?php } ?>



<?php if (!is_callable('smarty_function_cattr')) include '/home/mmotalks/web/mmotalks.ru/public_html/cms/framework/classes/modules/viewer/plugs/function.cattr.php';
if (!is_callable('smarty_function_cdata')) include '/home/mmotalks/web/mmotalks.ru/public_html/cms/framework/classes/modules/viewer/plugs/function.cdata.php';
...
-holder">
    ...
    <?php echo smarty_function_component(array('_default_short'=>'admin:field','template'=>'hidden','name'=>$_smarty_tpl->tpl_vars['name']->value,'value'=>$_smarty_tpl->tpl_vars['formid']->value),$_smarty_tpl);?>

    <?php echo smarty_function_component(array('_default_short'=>'admin:field','template'=>'hidden','name'=>$_smarty_tpl->tpl_vars['name']->value,'value'=>$_smarty_tpl->tpl_vars['key']->value),$_smarty_tpl);?>
