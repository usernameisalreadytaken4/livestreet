<?php /* Smarty version Smarty-3.1.13, created on 2018-06-28 18:45:21
         compiled from "C:\xampp\htdocs\application\frontend\skin\developer\actions\ActionBlog\add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19401635275b3502916ee040-65726773%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e37b987fd55f1bd2170738b1ce5b8d5c2173c88d' => 
    array (
      0 => 'C:\\xampp\\htdocs\\application\\frontend\\skin\\developer\\actions\\ActionBlog\\add.tpl',
      1 => 1530188511,
      2 => 'file',
    ),
    '82ce699fd00e04d22189b6fe988601775ae80cad' => 
    array (
      0 => 'C:\\xampp\\htdocs\\application\\frontend\\skin\\developer\\layouts\\layout.blog.edit.tpl',
      1 => 1530188513,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '19401635275b3502916ee040-65726773',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b3502917e8086_13516032',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b3502917e8086_13516032')) {function content_5b3502917e8086_13516032($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include 'C:\\xampp\\htdocs\\framework/classes/modules/viewer/plugs\\function.component_define_params.php';
...
<?php $_tmp1=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_router(array('page'=>'blog'),$_smarty_tpl);?>
<?php $_tmp2=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['layoutNav'] = new Smarty_variable(array(array('hook'=>'blog_edit','activeItem'=>$_smarty_tpl->tpl_vars['sMenuItemSelect']->value,'items'=>array(array('name'=>'profile','url'=>$_tmp1."edit/".((string)$_smarty_tpl->tpl_vars['blogEdit']->value->getId())."/",'text'=>$_smarty_tpl->tpl_vars['aLang']->value['blog']['admin']['nav']['profile']),array('name'=>'admin','url'=>$_tmp2."admin/".((string)$_smarty_tpl->tpl_vars['blogEdit']->value->getId())."/",'text'=>$_smarty_tpl->tpl_vars['aLang']->value['blog']['admin']['nav']['users'])))), null, 0);?>
    <?php }?>
...
">
    ...
    <?php if ($_smarty_tpl->tpl_vars['sEvent']->value=='add'){?>
        <?php echo $_smarty_tpl->tpl_vars['aLang']->value['blog']['add']['title'];?>

    <?php }else{ ?>
        <?php echo $_smarty_tpl->tpl_vars['aLang']->value['blog']['admin']['title'];?>
: <a href="<?php echo $_smarty_tpl->tpl_vars['blogEdit']->value->getUrlFull();?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['blogEdit']->value->getTitle(), ENT_QUOTES, 'UTF-8', true);?>
</a>
    <?php }?>
...
?>
    ...
    <?php echo smarty_function_component(array('_default_short'=>'blog','template'=>'add','blog'=>$_smarty_tpl->tpl_vars['blogEdit']->value),$_smarty_tpl);?>
