<?php /* Smarty version Smarty-3.1.13, created on 2018-06-28 15:08:02
         compiled from "/home/mmotalks/web/mmotalks.ru/public_html/cms/application/plugins/page/frontend/skin/default/actions/ActionPage/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3032004265b34cfa29ca783-93336100%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8c2146ec2e3762cba37e86f90b1e54b0d270d7a0' => 
    array (
      0 => '/home/mmotalks/web/mmotalks.ru/public_html/cms/application/plugins/page/frontend/skin/default/actions/ActionPage/view.tpl',
      1 => 1529958458,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3032004265b34cfa29ca783-93336100',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b34cfa2e05be5_81770038',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b34cfa2e05be5_81770038')) {function content_5b34cfa2e05be5_81770038($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/home/mmotalks/web/mmotalks.ru/public_html/cms/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
<?php echo smarty_function_component_define_params(array('params'=>array('mods','classes','attributes')),$_smarty_tpl);?>
	...
	<?php $_smarty_tpl->tpl_vars['layoutNoSidebar'] = new Smarty_variable(!Config::Get('plugin.page.show_block_structure'), null, 0);?>
...
">
	...
	<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['oPage']->value->getTitle(), ENT_QUOTES, 'UTF-8', true);?>
...
?>
	...
	<?php if ($_smarty_tpl->tpl_vars['oUserCurrent']->value&&$_smarty_tpl->tpl_vars['oUserCurrent']->value->isAdministrator()){?>
		<?php $_smarty_tpl->tpl_vars['items'] = new Smarty_variable(array(array('icon'=>'edit','url'=>$_smarty_tpl->tpl_vars['oPage']->value->getAdminEditWebUrl(),'text'=>$_smarty_tpl->tpl_vars['aLang']->value['common']['edit'])), null, 0);?>
	...
	<?php $_smarty_tpl->_capture_stack[0][] = array('page_text', null, null); ob_start(); ?>
		<?php if (!$_smarty_tpl->tpl_vars['oPage']->value->getAutoBr()||Config::Get('view.wysiwyg')){?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
	...
	<?php echo smarty_function_component(array('_default_short'=>'text','text'=>Smarty::$_smarty_vars['capture']['page_text']),$_smarty_tpl);?>
