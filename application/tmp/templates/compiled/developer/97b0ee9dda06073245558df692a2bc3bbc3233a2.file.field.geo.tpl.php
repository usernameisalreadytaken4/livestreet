<?php /* Smarty version Smarty-3.1.13, created on 2018-07-08 21:28:03
         compiled from "E:\XAMPP\htdocs\framework\frontend\components\field\field.geo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10835553645b4257b37ed3c3-05041179%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '97b0ee9dda06073245558df692a2bc3bbc3233a2' => 
    array (
      0 => 'E:\\XAMPP\\htdocs\\framework\\frontend\\components\\field\\field.geo.tpl',
      1 => 1530188559,
      2 => 'file',
    ),
    'ec2329882a58453d432dc9f4871aac310796982d' => 
    array (
      0 => 'E:\\XAMPP\\htdocs\\framework\\frontend\\components\\field\\field.tpl',
      1 => 1530188559,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10835553645b4257b37ed3c3-05041179',
  'function' => 
  array (
  ...
  'unifunc' => 'content_5b4257b385a9e9_88118064',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b4257b385a9e9_88118064')) {function content_5b4257b385a9e9_88118064($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include 'E:\\XAMPP\\htdocs\\framework/classes/modules/viewer/plugs\\function.component_define_params.php';
if (!is_callable('smarty_function_field_make_rule')) include 'E:\\XAMPP\\htdocs\\framework/classes/modules/viewer/plugs\\function.field_make_rule.php';
if (!is_callable('smarty_function_field_get_value')) include 'E:\\XAMPP\\htdocs\\framework/classes/modules/viewer/plugs\\function.field_get_value.php';
if (!is_callable('smarty_function_cmods')) include 'E:\\XAMPP\\htdocs\\framework/classes/modules/viewer/plugs\\function.cmods.php';
if (!is_callable('smarty_function_cdata')) include 'E:\\XAMPP\\htdocs\\framework/classes/modules/viewer/plugs\\function.cdata.php';
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['value'] = new Smarty_variable((($tmp = @$_tmp1)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['value']->value : $tmp), null, 0);?>
    ...
    <?php echo smarty_function_component_define_params(array('params'=>array('place','countries','regions','cities','targetType')),$_smarty_tpl);?>
    ...
    <?php $_smarty_tpl->tpl_vars['name'] = new Smarty_variable((($tmp = @$_smarty_tpl->tpl_vars['name']->value)===null||$tmp==='' ? 'geo' : $tmp), null, 0);?>



<?php if (!is_callable('smarty_function_cattr')) include 'E:\XAMPP\htdocs\framework/classes/modules/viewer/plugs\function.cattr.php';
if (!is_callable('smarty_function_cdata')) include 'E:\XAMPP\htdocs\framework/classes/modules/viewer/plugs\function.cdata.php';
...
-holder">
    ...
    <?php if (!is_callable('smarty_function_lang')) include 'E:\XAMPP\htdocs\framework/classes/modules/viewer/plugs\function.lang.php';
?><?php if (!function_exists('smarty_template_function_field_geo_select')) {
    function smarty_template_function_field_geo_select($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['field_geo_select']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
        <select class="<?php echo $_smarty_tpl->tpl_vars['component']->value;?>
-geo-<?php echo $_smarty_tpl->tpl_vars['type']->value;?>
 js-field-geo-<?php echo $_smarty_tpl->tpl_vars['type']->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars['name']->value;?>
[<?php echo $_smarty_tpl->tpl_vars['type']->value;?>
]" <?php if (!$_smarty_tpl->tpl_vars['display']->value){?>style="display:none;"<?php }?>>
            <option value=""><?php echo smarty_function_lang(array('_default_short'=>"field.geo.select_".((string)$_smarty_tpl->tpl_vars['type']->value)),$_smarty_tpl);?>
</option>
...
?>
                <option value="<?php echo $_smarty_tpl->tpl_vars['item']->value->getId();?>
" <?php if ($_smarty_tpl->tpl_vars['selectedItem']->value==$_smarty_tpl->tpl_vars['item']->value->getId()){?>selected="selected"<?php }?>>
...
foreach (Smarty::$global_tpl_vars as $key => $value) if(!isset($_smarty_tpl->tpl_vars[$key])) $_smarty_tpl->tpl_vars[$key] = $value;}}?>
    ...
    <?php smarty_template_function_field_geo_select($_smarty_tpl,array('type'=>'country','items'=>$_smarty_tpl->tpl_vars['countries']->value,'selectedItem'=>($_smarty_tpl->tpl_vars['place']->value ? $_smarty_tpl->tpl_vars['place']->value->getCountryId() : false)));?>


    
    <?php smarty_template_function_field_geo_select($_smarty_tpl,array('type'=>'region','items'=>$_smarty_tpl->tpl_vars['regions']->value,'selectedItem'=>($_smarty_tpl->tpl_vars['place']->value ? $_smarty_tpl->tpl_vars['place']->value->getRegionId() : false),'display'=>($_smarty_tpl->tpl_vars['place']->value&&$_smarty_tpl->tpl_vars['place']->value->getCountryId())));?>


    
    <?php smarty_template_function_field_geo_select($_smarty_tpl,array('type'=>'city','items'=>$_smarty_tpl->tpl_vars['cities']->value,'selectedItem'=>($_smarty_tpl->tpl_vars['place']->value ? $_smarty_tpl->tpl_vars['place']->value->getCityId() : false),'display'=>($_smarty_tpl->tpl_vars['place']->value&&$_smarty_tpl->tpl_vars['place']->value->getRegionId())));?>
