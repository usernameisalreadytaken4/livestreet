<?php /* Smarty version Smarty-3.1.13, created on 2018-07-04 18:31:55
         compiled from "C:\xampp\htdocs\application\frontend\skin\developer\actions\ActionSettings\profile.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12445055155b3ce86bafa4f5-05118929%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6a061a0d9e83c2a368fde3a814cca7ba318116a4' => 
    array (
      0 => 'C:\\xampp\\htdocs\\application\\frontend\\skin\\developer\\actions\\ActionSettings\\profile.tpl',
      1 => 1530188511,
      2 => 'file',
    ),
    '9097d16d1cfadd6687cec1dbcdeab4bac6dba5c2' => 
    array (
      0 => 'C:\\xampp\\htdocs\\application\\frontend\\skin\\developer\\layouts\\layout.user.settings.tpl',
      1 => 1530188513,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '12445055155b3ce86bafa4f5-05118929',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b3ce86bc177b9_36442563',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b3ce86bc177b9_36442563')) {function content_5b3ce86bc177b9_36442563($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include 'C:\\xampp\\htdocs\\framework/classes/modules/viewer/plugs\\function.component_define_params.php';
...
<?php echo smarty_function_component_define_params(array('params'=>array('mods','classes','attributes')),$_smarty_tpl);?>
    ...
    <?php ob_start();?><?php echo smarty_function_router(array('page'=>'settings'),$_smarty_tpl);?>
<?php $_tmp1=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_lang(array('name'=>'user.settings.nav.profile'),$_smarty_tpl);?>
<?php $_tmp2=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_router(array('page'=>'settings'),$_smarty_tpl);?>
<?php $_tmp3=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_lang(array('name'=>'user.settings.nav.account'),$_smarty_tpl);?>
<?php $_tmp4=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_router(array('page'=>'settings'),$_smarty_tpl);?>
<?php $_tmp5=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_lang(array('name'=>'user.settings.nav.tuning'),$_smarty_tpl);?>
<?php $_tmp6=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_router(array('page'=>'settings'),$_smarty_tpl);?>
<?php $_tmp7=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_lang(array('name'=>'user.settings.nav.invites'),$_smarty_tpl);?>
<?php $_tmp8=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['layoutNav'] = new Smarty_variable(array(array('hook'=>'settings','activeItem'=>$_smarty_tpl->tpl_vars['sMenuSubItemSelect']->value,'items'=>array(array('url'=>$_tmp1."profile/",'text'=>$_tmp2,'name'=>'profile'),array('url'=>$_tmp3."account/",'text'=>$_tmp4,'name'=>'account'),array('url'=>$_tmp5."tuning/",'text'=>$_tmp6,'name'=>'tuning'),array('url'=>$_tmp7."invite/",'text'=>$_tmp8,'name'=>'invite')))), null, 0);?>
...
?>
    ...
    <?php echo smarty_function_component(array('_default_short'=>'user','template'=>'settings/profile','user'=>$_smarty_tpl->tpl_vars['oUserCurrent']->value),$_smarty_tpl);?>
