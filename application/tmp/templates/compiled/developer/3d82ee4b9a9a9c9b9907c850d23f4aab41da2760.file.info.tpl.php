<?php /* Smarty version Smarty-3.1.13, created on 2018-06-28 15:04:03
         compiled from "/home/mmotalks/web/mmotalks.ru/public_html/cms/application/frontend/components/user/info.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10022461575b34ceb3736ea9-46169938%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3d82ee4b9a9a9c9b9907c850d23f4aab41da2760' => 
    array (
      0 => '/home/mmotalks/web/mmotalks.ru/public_html/cms/application/frontend/components/user/info.tpl',
      1 => 1529954501,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10022461575b34ceb3736ea9-46169938',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b34ceb3a0a8a6_83576674',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b34ceb3a0a8a6_83576674')) {function content_5b34ceb3a0a8a6_83576674($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/home/mmotalks/web/mmotalks.ru/public_html/cms/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
<?php $_tmp8=ob_get_clean();?><?php echo smarty_function_component(array('_default_short'=>'user','template'=>'info-group','name'=>'contact','title'=>$_tmp8,'items'=>$_smarty_tpl->tpl_vars['items']->value),$_smarty_tpl);?>
...
<?php $_tmp9=ob_get_clean();?><?php echo smarty_function_component(array('_default_short'=>'user','template'=>'info-group','name'=>'social-networks','title'=>$_tmp9,'items'=>$_smarty_tpl->tpl_vars['items']->value),$_smarty_tpl);?>
...
$_smarty_tpl->tpl_vars['items']->value[] = array('label'=>$_tmp10,'content'=>"<a href=\"".((string)$_smarty_tpl->tpl_vars['invitedByUser']->value->getUserWebPath())."\">".((string)$_smarty_tpl->tpl_vars['invitedByUser']->value->getDisplayName())."</a>");?>
<?php }?>
...
$_smarty_tpl->tpl_vars['items']->value[] = array('label'=>$_tmp11,'content'=>$_smarty_tpl->tpl_vars['users']->value);?>
<?php }?>
...
<?php $_tmp12=ob_get_clean();?><?php ob_start();?><?php if (!$_smarty_tpl->tpl_vars['blog']->last){?><?php echo ", ";?><?php }?><?php $_tmp13=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['blogs'] = new Smarty_variable(($_smarty_tpl->tpl_vars['blogs']->value).("<a href=\"".((string)$_smarty_tpl->tpl_vars['blog']->value->getUrlFull())."\">".$_tmp12."</a>".$_tmp13), null, 0);?>
    <?php } ?>
...
?>
        <?php $_smarty_tpl->tpl_vars['blog'] = new Smarty_variable($_smarty_tpl->tpl_vars['blogUser']->value->getBlog(), null, 0);?>
        <?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['blog']->value->getTitle(), ENT_QUOTES, 'UTF-8', true);?>
<?php $_tmp21=ob_get_clean();?><?php ob_start();?><?php if (!$_smarty_tpl->tpl_vars['blogUser']->last){?><?php echo ", ";?><?php }?><?php $_tmp22=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['blogs'] = new Smarty_variable(($_smarty_tpl->tpl_vars['blogs']->value).("<a href=\"".((string)$_smarty_tpl->tpl_vars['blog']->value->getUrlFull())."\">".$_tmp21."</a>".$_tmp22), null, 0);?>
    <?php } ?>

    <?php ob_start();?><?php echo smarty_function_lang(array('name'=>'user.profile.activity.blogs_joined'),$_smarty_tpl);?>
<?php $_tmp23=ob_get_clean();?><?php $_smarty_tpl->createLocalArrayVariable('items', null, 0);
$_smarty_tpl->tpl_vars['items']->value[] = array('label'=>$_tmp23,'content'=>$_smarty_tpl->tpl_vars['blogs']->value);?>
<?php }?>


<?php ob_start();?><?php echo smarty_function_lang(array('name'=>'user.date_registration'),$_smarty_tpl);?>
<?php $_tmp24=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_date_format(array('date'=>$_smarty_tpl->tpl_vars['user']->value->getDateRegister()),$_smarty_tpl);?>
<?php $_tmp25=ob_get_clean();?><?php $_smarty_tpl->createLocalArrayVariable('items', null, 0);
$_smarty_tpl->tpl_vars['items']->value[] = array('label'=>$_tmp24,'content'=>$_tmp25);?>
...
<?php $_tmp26=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_date_format(array('date'=>$_smarty_tpl->tpl_vars['session']->value->getDateLast()),$_smarty_tpl);?>
...
<?php $_tmp28=ob_get_clean();?><?php echo smarty_function_component(array('_default_short'=>'user','template'=>'info-group','name'=>'activity','title'=>$_tmp28,'items'=>$_smarty_tpl->tpl_vars['items']->value),$_smarty_tpl);?>



<?php if ($_smarty_tpl->tpl_vars['friends']->value){?>
    <?php $_smarty_tpl->_capture_stack[0][] = array('user_info_friends', null, null); ob_start(); ?>
        <?php echo smarty_function_component(array('_default_short'=>'user','template'=>'avatar-list','users'=>$_smarty_tpl->tpl_vars['friends']->value),$_smarty_tpl);?>
...
<?php $_tmp29=ob_get_clean();?><?php echo smarty_function_component(array('_default_short'=>'user','template'=>'info-group','name'=>'wall','title'=>$_tmp29,'html'=>Smarty::$_smarty_vars['capture']['user_info_wall']),$_smarty_tpl);?>
